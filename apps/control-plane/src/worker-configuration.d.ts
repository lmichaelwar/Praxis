/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc src/worker-configuration.d.ts` (hash: 373fa94fb8791e4e773fed873531e81c)
// Runtime types generated with workerd@1.20260825.1 2026-08-26 nodejs_compat
interface __BaseEnv_Env {
	MEDIA: R2Bucket;
	PRAXIS_PROVIDER_MODE: "fake";
	PRAXIS_IMAGE_MODEL: "gpt-image-2";
	PRAXIS_TTS_MODEL: "gpt-4o-mini-tts";
	PRAXIS_TTS_VOICE: "alloy";
	PRAXIS_ALLOWED_ORIGIN: "http://127.0.0.1:4173";
	PRAXIS_RENDER_WORKER_URL: "http://127.0.0.1:8790";
	PRAXIS_FAKE_IMAGE_URL: "http://127.0.0.1:4173/media/fax-oracle-corridor.png";
	PROJECT_ROOMS: DurableObjectNamespace<import("./index").ProjectRoom>;
	RENDER_CONTAINERS: DurableObjectNamespace<import("./index").RenderContainer>;
	MEDIA_WORKFLOW: Workflow<Parameters<import("./index").MediaWorkflow['run']>[0]['payload']>;
	RENDER_WORKFLOW: Workflow<Parameters<import("./index").RenderWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "ProjectRoom" | "RenderContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PRAXIS_PROVIDER_MODE" | "PRAXIS_IMAGE_MODEL" | "PRAXIS_TTS_MODEL" | "PRAXIS_TTS_VOICE" | "PRAXIS_ALLOWED_ORIGIN" | "PRAXIS_RENDER_WORKER_URL" | "PRAXIS_FAKE_IMAGE_URL">> {}
}
